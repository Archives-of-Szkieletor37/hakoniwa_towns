...
extern void delete_LinkedList_specialtown(LinkedList_SpecialTown **llst_ptr);

extern LinkedList_SpecialTown *nth_LinkedList_specialtown(LinkedList_SpecialTown *llst, int n);

extern int insert_nth_specialtown(LinkedList_SpecialTown **llst_ptr, SpecialTown st, int n);

extern int push_LinkedList_specialtown(LinkedList_SpecialTown **llst_ptr, SpecialTown st);
